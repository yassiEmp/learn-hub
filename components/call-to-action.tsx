...
export default function CallToAction() {
    return (
        <section className="bg-muted dark:bg-background py-16 md:py-32 min-h-screen flex justify-center items-center">
            <div className="mx-auto max-w-5xl px-6">
                <div className="mx-auto max-w-md text-center">
                    <h2 className="text-balance text-3xl font-semibold md:text-4xl">Create, Sell and Grow</h2>
                    <p className="text-muted-foreground mt-4 text-balance">Join a community of over 1000+ companies and developers who have already discovered the power of Tailark.</p>
