    ...
    <>
      ...
      >
        <AnimatePresence mode="wait" initial={false}>
          <motion.span
            key={currentIndex}
            className={`absolute top-0 left-0 font-bold ${className} not-dark:bg-gradient-to-r  not-dark:from-80% not-dark:from-[#EFA6DF] not-dark:to-[#4CB9DF] bg-foreground to-95%% bg-clip-text text-transparent`}
